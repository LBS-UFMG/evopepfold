...
def countContacts(candidate_file, target = None, cutoff = 5.0):
    if target == None:
        target = [('24', 'THR'), ('25', 'THR'), ('26', 'THR'), ('27', 'LEU'), ('41', 'HIS'), ('49', 'MET'),
                  ('140', 'PHE'), ('141', 'LEU'), ('142', 'ASN'), ('143', 'GLY'), ('144', 'SER'), ('145', 'CYS'),
                  ('164', 'HIS'), ('165', 'MET'), ('166', 'GLU'), ('167', 'LEU'), ('168', 'PRO'), ('172', 'HIS'),
                  ('187', 'ASP'), ('188', 'ARG'), ('189', 'GLN'), ('190', 'THR'), ('191', 'ALA'), ('192', 'GLN')]
    pymol.cmd.reinitialize()
    stored.list = []
...
if __name__ == '__main__':
    ...
    p, bf, wf, af, bi, mo, bo = GA(initial_population,max_generations = 20, nsims = 10, pop_size=105, workers=15)
    e = time.time()
